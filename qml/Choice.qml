...
ComboBox {
    ...
    background: Rectangle { radius: 10; color: control.hovered ? Theme.hover : Theme.control; border.color: control.activeFocus ? Theme.accent : Theme.line; border.width: .6; Behavior on color { ColorAnimation { duration: 120 } } }
