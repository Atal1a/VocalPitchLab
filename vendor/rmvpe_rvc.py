# Vendored RVC RMVPE; see LICENSE-RVC and provenance.json.
...
jit = None  # VocalPitchLab: JIT disabled; no RVC app imports
...
class RMVPE:
    def __init__(self, model_path: str, is_half, device=None, use_jit=False):
        assert not use_jit, 'VocalPitchLab supports eager inference only'
